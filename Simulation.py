...
from lib.PerturbedHistoryExploration import PerturbedHistoryExploration
from lib.UCBLinear import UCBLinear
from lib.TSLinear import TSLinear
from lib.PHELinear import PHELinear
...
if __name__ == '__main__':
	...
	algorithms['UpperConfidenceBound'] = UpperConfidenceBound(num_arm=n_articles, standard_deviation=NoiseScale)
	algorithms['ThompsonSampling'] = ThompsonSampling(num_arm=n_articles, standard_deviation=NoiseScale)
	# algorithms['PerturbedHistoryExploration'] = PerturbedHistoryExploration(num_arm=n_articles, alpha=1)
	# algorithms['EpsilonGreedyLinearBandit'] = EpsilonGreedyLinearBandit(dimension=context_dimension, lambda_=0.1, epsilon=None)
	# algorithms['UCBLinear'] = UCBLinear(dimension=context_dimension, lambda_=0.1, standard_deviation=NoiseScale, alpha=0.1)
	# algorithms['TSLinear'] = TSLinear(dimension=context_dimension, lambda_=context_dimension, standard_deviation=NoiseScale)
	# algorithms['PHELinear'] = PHELinear(dimension=context_dimension, n_articles=n_articles, lambda_=1, alpha=2)
